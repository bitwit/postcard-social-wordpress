...
?>
            ...
            <div class="video-container">
                <video id="postcard-video-<?php echo $postcard->postcard_id; ?>" poster="<?php echo $postcard->image; ?>" data-width="<?php echo $postcard->width; ?>" data-height="<?php echo $postcard->height; ?>" class="video-js vjs-default-skin" controls loop preload="auto">
